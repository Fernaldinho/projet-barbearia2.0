        ...
        <nav className="fixed top-0 w-full z-50 bg-[#131313]/80 backdrop-blur-xl">
          <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-4">
              <Link to={ROUTES.LOGIN} className="text-[#E5E2E1] hover:text-[#FBBF24] transition-colors font-headline font-bold">Entrar</Link>
          ...
          <section className="relative min-h-[870px] flex items-center justify-center overflow-hidden px-6">
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <a href="#" className="w-full sm:w-auto border border-[#4f4633]/30 text-[#e5e2e1] px-10 py-4 rounded-full font-headline font-bold text-lg hover:bg-[#1c1b1b] transition-all flex items-center justify-center gap-2">
